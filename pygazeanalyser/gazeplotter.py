...
def draw_display(dispsize, imagefile=None):
	...
	if imagefile != None:
		...
		x = int(dispsize[0]/2 - w/2)	#SEBASTIAN: ADDED AN INT() WRAPPER HERE
		y = int(dispsize[1]/2 - h/2)	#Without wrapper x or y could return as floats which returns error when indexing screen[] below.
